...
public class TestChromeProcessor {
    @Test
    @SuppressWarnings("unchecked")
    public void testProcessor() throws StageException {
        ProcessorRunner runner = new ProcessorRunner.Builder(ChromeDProcessor.class)
        ...
        try {
            ...
            map.put("url", Field.create("http://www.example.com"));
            ...
            Assert.assertEquals(doc.title(), "Example Domain");
